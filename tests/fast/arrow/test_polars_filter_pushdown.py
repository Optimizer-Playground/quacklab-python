...
class TestPolarsLazyFrameFilterPushdown:
    ...
    def test_comparison_equal(self):
        ...
        assert quacklab.sql("SELECT * FROM lf WHERE a = 3").fetchall() == [(3,)]

    def test_comparison_not_equal(self):
        lf = pl.LazyFrame({"a": [1, 2, 3, 4, 5]})
        assert quacklab.sql("SELECT * FROM lf WHERE a != 3").fetchall() == [(1,), (2,), (4,), (5,)]

    def test_comparison_less_than(self):
        lf = pl.LazyFrame({"a": [1, 2, 3, 4, 5]})
        assert quacklab.sql("SELECT * FROM lf WHERE a < 3").fetchall() == [(1,), (2,)]

    def test_comparison_less_than_or_equal(self):
        lf = pl.LazyFrame({"a": [1, 2, 3, 4, 5]})
        assert quacklab.sql("SELECT * FROM lf WHERE a <= 3").fetchall() == [(1,), (2,), (3,)]

    def test_comparison_greater_than(self):
        lf = pl.LazyFrame({"a": [1, 2, 3, 4, 5]})
        assert quacklab.sql("SELECT * FROM lf WHERE a > 3").fetchall() == [(4,), (5,)]

    def test_comparison_greater_than_or_equal(self):
        lf = pl.LazyFrame({"a": [1, 2, 3, 4, 5]})
        assert quacklab.sql("SELECT * FROM lf WHERE a >= 3").fetchall() == [(3,), (4,), (5,)]

    def test_string_comparison(self):
        lf = pl.LazyFrame({"name": ["alice", "bob", "charlie"], "val": [1, 2, 3]})
        assert quacklab.sql("SELECT * FROM lf WHERE name = 'bob'").fetchall() == [("bob", 2)]
    ...
    def test_nan_equal(self):
        ...
        result = quacklab.sql("SELECT * FROM lf WHERE a = 'NaN'::DOUBLE").fetchall()
        assert len(result) == 1
    ...
    def test_is_null_filter(self):
        ...
        result = quacklab.sql("SELECT * FROM lf WHERE a = 1 OR a IS NOT DISTINCT FROM NULL").fetchall()
    ...
    def test_is_not_null_filter(self):
        ...
        lf = pl.LazyFrame({"a": [1, None, 3, None, 5]})
        result = quacklab.sql("SELECT * FROM lf WHERE a = 1 OR a IS DISTINCT FROM NULL").fetchall()
    ...
    def test_conjunction_and_range(self):
        ...
        lf = pl.LazyFrame({"a": [1, 2, 3, 4, 5]})
        result = quacklab.sql("SELECT * FROM lf WHERE a BETWEEN 2 AND 4").fetchall()
        assert result == [(2,), (3,), (4,)]
    ...
    def test_conjunction_and_multi_column(self):
        ...
        result = quacklab.sql("SELECT * FROM lf WHERE a > 2 AND b = 'x'").fetchall()
    ...
    def test_conjunction_or(self):
        lf = pl.LazyFrame({"a": [1, 2, 3, 4, 5]})
        result = quacklab.sql("SELECT * FROM lf WHERE a = 1 OR a = 5").fetchall()
    ...
    def test_in_filter(self):
        lf = pl.LazyFrame({"a": [1, 2, 3, 4, 5]})
        result = quacklab.sql("SELECT * FROM lf WHERE a IN (2, 4)").fetchall()
    ...
    def test_struct_extract(self):
        ...
        result = quacklab.sql("SELECT * FROM lf WHERE s.x > 1").fetchall()
        assert len(result) == 2
    ...
    def test_optional_filter(self):
        ...
        lf = pl.LazyFrame({"a": [1, 2, 3, 4, 5]})
        result = quacklab.sql("SELECT * FROM lf WHERE a = 1 OR a = 3").fetchall()
    ...
    def test_top_n_nulls_first_includes_min(self):
        ...
        result = quacklab.sql("SELECT * FROM lf ORDER BY x ASC NULLS FIRST LIMIT 1").fetchall()
        assert result == [(1,)]
    ...
    def test_unfiltered_scan(self):
        ...
        result = quacklab.sql("SELECT * FROM lf").fetchall()
    ...
    def test_column_projection(self):
        ...
        result = quacklab.sql("SELECT a, c FROM lf").fetchall()
    ...
    def test_empty_result(self):
        lf = pl.LazyFrame({"a": [1, 2, 3]})
        result = quacklab.sql("SELECT * FROM lf WHERE a > 100").fetchall()
        assert result == []
