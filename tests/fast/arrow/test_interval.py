...
class TestArrowInterval:
    def test_duration_types(self, duckdb_cursor):
        ...
        rel = quacklab.from_arrow(arrow_table).fetch_arrow_table()
    ...
    def test_duration_overflow(self, duckdb_cursor):
        ...
        with pytest.raises(quacklab.ConversionException, match="Could not convert Interval to Microsecond"):
            quacklab.from_arrow(arrow_table).fetch_arrow_table()
