...
class TestToCSV:
    def test_basic_to_csv(self):
        ...
        csv_rel = quacklab.read_csv(temp_file_name)
    ...
    def test_to_csv_sep(self):
        ...
        csv_rel = quacklab.read_csv(temp_file_name, sep=",")
        assert rel.execute().fetchall() == csv_rel.execute().fetchall()
    ...
    def test_to_csv_na_rep(self):
        ...
        csv_rel = quacklab.read_csv(temp_file_name, na_values="test")
        assert rel.execute().fetchall() == csv_rel.execute().fetchall()
    ...
    def test_to_csv_quotechar(self):
        ...
        csv_rel = quacklab.read_csv(temp_file_name, sep=",", quotechar="'")
        assert rel.execute().fetchall() == csv_rel.execute().fetchall()
    ...
    def test_to_csv_escapechar(self):
        ...
        csv_rel = quacklab.read_csv(temp_file_name, quotechar='"', escapechar="!")
        assert rel.execute().fetchall() == csv_rel.execute().fetchall()
    ...
    def test_to_csv_date_format(self):
        ...
        csv_rel = quacklab.read_csv(temp_file_name, date_format="%Y%m%d")
    ...
    def test_to_csv_timestamp_format(self):
        ...
        csv_rel = quacklab.read_csv(temp_file_name, timestamp_format="%m/%d/%Y")
    ...
    def test_to_csv_encoding_incorrect(self):
        ...
        rel = quacklab.from_df(df)
        with pytest.raises(
            quacklab.InvalidInputException, match="Invalid Input Error: The only supported encoding option is 'UTF8"
        ):
    ...
    def test_compression_gzip(self):
        ...
        csv_rel = quacklab.read_csv(temp_file_name, compression="gzip")
        assert rel.execute().fetchall() == csv_rel.execute().fetchall()
    ...
    def test_to_csv_partition_with_columns_written(self):
        ...
        rel = quacklab.from_df(df)
        res = quacklab.sql("FROM rel order by all")
    ...
    def test_to_csv_overwrite_not_enabled(self):
        ...
        with pytest.raises(quacklab.IOException, match="OVERWRITE"):
            rel.to_csv(temp_file_name, header=True, partition_by=["c_category_1"])
    ...
    def test_to_csv_per_thread_output(self):
        ...
        csv_rel = quacklab.read_csv(f"{temp_file_name}/*.csv", header=True)
        assert rel.execute().fetchall() == csv_rel.execute().fetchall()
    ...
    def test_to_csv_use_tmp_file(self):
        ...
        csv_rel = quacklab.read_csv(temp_file_name, header=True)
        assert rel.execute().fetchall() == csv_rel.execute().fetchall()
