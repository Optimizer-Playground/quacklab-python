...
import quacklab
from quacklab.sqltypes import BIGINT, INTEGER, VARCHAR
...
class TestPyArrowUDF:
    def test_basic_use(self):
        ...
        vector_size = quacklab.__standard_vector_size__
    ...
    def test_cast_varchar_to_int(self):
        ...
        with pytest.raises(quacklab.ConversionException, match="""Could not convert string 'test' to INT64"""):
    ...
    def test_return_none(self):
        ...
        with pytest.raises(quacklab.Error, match="""Could not convert the result into an Arrow Table"""):
    ...
    def test_empty_result(self):
        ...
        with pytest.raises(quacklab.InvalidInputException, match="Returned pyarrow table should have 1 tuples, found 0"):
    ...
    def test_excessive_result(self):
        ...
        with pytest.raises(quacklab.InvalidInputException, match="Returned pyarrow table should have 1 tuples, found 5"):
