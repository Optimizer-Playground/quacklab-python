...
import quacklab
from quacklab.sqltypes import BIGINT, VARCHAR
...
class TestRemoveFunction:
    ...
    def test_double_remove(self):
        ...
        with pytest.raises(quacklab.CatalogException, match="Scalar Function with name func does not exist!"):
            con.sql("select func(42)")
    ...
    def test_use_after_remove_and_recreation(self):
        ...
        with pytest.raises(quacklab.BinderException, match="No function matches the given name"):
            con.sql("select func(42)")
    ...
    def test_overwrite_name(self):
        ...
        with pytest.raises(
            quacklab.NotImplementedException,
        ...
        with pytest.raises(
            quacklab.CatalogException, match="Catalog Error: Scalar Function with name func does not exist!"
        ):
